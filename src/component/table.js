...
function Table() {
    ...
    function createcell() {
        return (
            // <td style={tdStyle} className="blanc" key={t + " " + indexRow} id={t + " " + indexRow}/>
            <td></td>
        )
    }
...
//         for (let i = 0; path[i]; ++i) {
//             domTab[path[i][1]][path[i][0]].className = 'path'
...
//              <button type="button" onClick={drawLineTest} >Find path</button>
